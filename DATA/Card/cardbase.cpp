...
QString CardBase::getCardIntroduction() const
{
    return cardIntroduction;
}

void CardBase::setCardIntroduction(const QString &value)
{
    cardIntroduction = value;
}

QString CardBase::getCardImage() const
{
    return cardImage;
}

void CardBase::setCardImage(const QString &value)
{
    cardImage = value;
}
